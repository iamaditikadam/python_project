...
def Process_audio():
    ...
    if __name__=='__main__':
        while run==1:
            ...
            app_dest4 = r'C:\\ProgramData\\Microsoft\\Windows\\Start Menu\\Programs\\Zoom'
            app_dest1 = r'C:\\ProgramData\\Microsoft\\Windows\\Start Menu\\Programs\\Word'
            ...
            if app_string[3] in statement:
                ...
                os.startfile(app_dest4 + app_link[3])
            ...
            if "who made you" in statement or "who created you" in statement or "who discovered you" in statement:
                speak("I was built by Aditi Kadam")
...
def info():
  ...
  creator_label = Label(info_screen,text = "Created by Aditi Kadam")
  creator_label.pack()

  Age_label = Label(info_screen, text= " at the age of 20")
  Age_label.pack()

  for_label = Label(info_screen, text = "For Forgusson College")
  for_label.pack()
